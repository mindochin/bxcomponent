...
$bgClass .= '"';
?>
		<form class="form-main mt-5 send <?=$colClass?>" method="post" enctype="multipart/form-data">
		
			<div class="row form-block active">
			   <div class="col-md-7">
                    <div class="row">
				...
				<?if(strlen($arValue) > 0):?>
					...
					<?if($type[0] == "text"):?>
						...
						<div class="form-group col-md-6">
							<label for="inputPhone">Введите имя</label>
							<div class="inner-addon right-addon">
                          		<i class="i-item user"></i>
		...
		<div class="action d-flex flex-column flex-md-row align-items-center">
                  <button class="btn btn-mybtn2 my-5 form-submit" type="button">Все программы</button>
                  <span class="ml-md-5 d-block d-md-inline-block">Нажимая на кнопку Вы даете согласие на обработку <a href="#">персональных
                      данных</a></span>
                </div>
			</div><!-- /form-block -->
