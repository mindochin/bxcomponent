...
<div class="container">
	...
	<div id="content">
		<div class="row">
			<div class="col-md-12">
				...
				<h2>
					<small>Нужен сайт, но нет лишних денег?</small><br />
				...
				<div class="row">
					<div class="col-md-3">
					<noindex>
						<a href="http://ksp-okt.ru" class="thumbnail text-center" target="_blank" rel="nofollow">
							<div class="caption">
								<h4>Казначейство города</h4>
							</div>
					...
					<div class="col-md-3">
					<noindex>
						<a href="http://pravo-okt.ru" class="thumbnail text-center" target="_blank" rel="nofollow">
							<div class="caption">
								<h4>Третейский суд</h4>
							</div>
					...
					<div class="col-md-3">
					<noindex>
						<a href="http://vladname.ru/article/" class="thumbnail text-center" target="_blank" rel="nofollow">
							<div class="caption">
								<h4>Этот сайт/блог</h4>
							</div>
					...
					<div class="col-md-3">
					<noindex>
						<a href="http://npf-paker.ru" class="thumbnail text-center" target="_blank" rel="nofollow">
							<div class="caption">
								<h4>Сайт предприятия</h4>
							</div>
	...
	<div id="footer">
		<div class="row">
			...
			<div class="col-md-4">
<div class="row">
	<div class="col-xs-offset-4 col-xs-4 col-md-offset-0 col-md-12"><img src="/bitrix/templates/site-create/img/logo-footer.jpg" class="img-responsive img-circle" /></div>
</div>			
