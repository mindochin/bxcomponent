		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="thumbnail">
							<img src="/bitrix/templates/site-create/img/primer3.jpg" class="img-responsive"/>
							<div class="caption">
								<h3>Персональный сайт/блог
								</h3>
								<p><em>Хостинг, домен, дизайн, веротка, программирование, наполнение</em></p>
								<p>Сайт: <!--noindex--><a href="http://vladname.ru" target="_blank" rel="nofollow">vladname.ru</a><!--/noindex--></p>
							</div>
						</div>
					</div>
					...
					<div class="col-sm-4">
						<div class="thumbnail">
							<img src="/bitrix/templates/site-create/img/primer1.jpg" class="img-responsive"/>
							<div class="caption">
								<h3>Казначейство города
								</h3>
								<p><em>Хостинг, домен, дизайн, веротка, программирование</em></p>
								<p>Сайт: <!--noindex--><a href="http://ksp-okt.ru" target="_blank" rel="nofollow">ksp-okt.ru</a><!--/noindex--></p>
							</div>
						</div>
					</div>					
					...
					<div class="col-sm-4">
						<div class="thumbnail">
							<img src="/bitrix/templates/site-create/img/primer2.jpg" class="img-responsive"/>
							<div class="caption">
								<h3>Третейский суд
								</h3>
								<p><em>Хостинг, домен, дизайн, веротка, программирование, наполнение</em></p>
								<p>Сайт: <!--noindex--><a href="http://pravo-okt.ru" target="_blank" rel="nofollow">pravo-okt.ru</a><!--/noindex--></p>
							</div>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="thumbnail">
							<img src="/bitrix/templates/site-create/img/primer4.jpg" class="img-responsive"/>
							<div class="caption">
								<h3>Сайт промышленного предприятия
								</h3>
								<p><em>Дизайн, веротка, программирование, наполнение</em></p>
								<p>Сайт: <!--noindex--><a href="http://npf-paker.ru" target="_blank" rel="nofollow">npf-paker.ru</a><!--/noindex--></p>
							</div>
						</div>
					</div>
					...
					<div class="col-sm-4">
						<div class="thumbnail">
							<img src="/bitrix/templates/site-create/img/primer5.jpg" class="img-responsive"/>
							<div class="caption">
								<h3>Сайт производственного предприятия
								</h3>
								<p><em>Веротка, программирование, наполнение</em></p>								
								<p>Сайт: <!--noindex--><a href="http://mega-flex.ru" target="_blank" rel="nofollow">mega-flex.ru</a><!--/noindex--></p>								
							</div>
						</div>
					</div>
					...
					<div class="col-sm-4">
						<div class="thumbnail">
							<img src="/bitrix/templates/site-create/img/primer6.jpg" class="img-responsive"/>
							<div class="caption">
								<h3>Продающая страница производства сумок
								</h3>
								<p><em>Веротка, программирование, наполнение</em></p>
								<p>Сайт: <!--noindex--><a href="http://spanbag.ru" target="_blank" rel="nofollow">spanbag.ru</a><!--/noindex--></p>
							</div>
						</div>
					</div>
